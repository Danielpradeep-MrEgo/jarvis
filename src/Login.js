...
function Login() {
	...
	const [dan, setDan] = useState(true);
	const [username, setUsername] = useState([]);
	const [value, setValue] = useState(91);
	const [conformtrue, setConformtrue] = useState(true);

	const signIn = () => {
		auth
			.signInWithPopup(provider)
			// .then((result) => console.log(result, result.user.uid, result.user.email))
			.then((result) => {
				dispatch({
	...
	useEffect(() => {
		if (user) {
			db.collection("users").doc(`${user.phoneNumber}`).add({
	...
	return (
		<div className="login">
			<div className="login__set">
				<div className={dan === true ? "login__form" : "login__hide"}>
					{/* <div className="login__form"> */}
					<form>
						<h1>Sign in</h1>
						<h4>New User?</h4>
						{/* <div className="login__selectCont">
						{value} */}
						<div className="login__selectCont">
							<select
								id="country_list"
					...
					<div className={dan === true ? "login__button" : "login__buthide"}>
						<Button
							id="sign-in-button"
							type="submit"
							onClick={sign}
					...
					<h6>Protected by reCAPTCHA and subject to the Google</h6>
					<span style={{ display: "flex" }}>
						{" "}
						<h6>Privacy Policy</h6> <h5>&</h5> <h6>Terms of Service</h6>
					</span>
					.<h6>Mr.Ego</h6>
				</div>

				<div className={dan === false ? "login__form" : "login__dan"}>
					<form onSubmit={done}>
						<h1>Otp</h1>
						<h4>Confirm Otp</h4>
						<input
						...
						/>
						<div
							className={conformtrue == true ? "button__ok" : "button__okHide"}
						>
							<Button
								// onClick={conformtrue}
								id="sign-in-button"
						...
						<div
							className={conformtrue == false ? "button__ok" : "button__okapp"}
						>
							<Button
								id="sign-in-button"
								type="submit"
								onClick={done}
								style={{ fontStyle: "initial", textTransform: "initial" }}
							>
								done
							</Button>
					...
					<div></div>
					<h6>Protected by reCAPTCHA and subject to the Google</h6>
					<h6> Privacy Policy and Terms of Service</h6>.<h6>Mr.Ego</h6>
				</div>
			</div>
		</div>
	);
